-- Loyalty Campaign 
-- The company is planning a brand loyalty campaign for customers in Germany.
-- The first phase of this campaign will target only female customers of the Calvin Klein brand.
 -- Write a query to extract the top 5 customers (based on revenue generated)
